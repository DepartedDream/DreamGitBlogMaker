    ...
    class Program
    {
        ...
        public static void initialData()
        {
            try
            {
                ...
                #endregion
                Console.WriteLine("加载文章成功");
            }
            catch(Exception)
            {
                throw new Exception("初始化文章数据失败");
            }
            ...
            try
            {
                ...
                #endregion
                Console.WriteLine("加载音乐成功");
            }
            catch (Exception) 
            {
                throw new Exception("初始化音乐数据失败");
            }
        }
        ...
        public static void initialIndex()
        {
            ...
            {
                throw new Exception("生成网页失败");
            }
            Console.WriteLine("生成网页成功");
        }

        public static void gitIndex()
        {
            Git git = new Git("git", AppDomain.CurrentDomain.BaseDirectory);
            Console.WriteLine(git.Run("add ."));
            Console.WriteLine(git.Run("commit -m \"update article\""));
            Console.WriteLine(git.Run("push"));
        }
